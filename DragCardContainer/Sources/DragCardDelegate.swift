...
public protocol DragCardDelegate: NSObjectProtocol {
    ...
    func dragCard(_ dragCard: DragCardContainer, displayTopCardAt index: Int, with cardView: DragCardView)
    
    /// This method is called when the top card is removed.
    func dragCard(_ dragCard: DragCardContainer, didRemovedTopCardAt index: Int, direction: Direction, with cardView: DragCardView)
    
    /// This method is called when the last card is removed.
    /// **If `infiniteLoop` is true, this method not called**
    func dragCard(_ dragCard: DragCardContainer, didRemovedLast cardView: DragCardView)
